...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request payload for creating a new project with employer ID")
public class ProjectCreateWithEmployerRequestDto {
    ...
    @Schema(description = "ID of the employer creating the project", example = "1")
